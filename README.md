...
[프로젝트 데모 사이트 바로가기](https://dazzling-unicorn-ed9e87.netlify.app/)
...
3. **승자 결정 및 시각적 피드백**: 게임 결과에 따라 승자가 결정되고, 각 플레이어의 상자에는 이에 맞는 시각적 피드백이 제공됩니다. 승자 상자에는 🟢 초록 테두리가, 패자 상자에는 🔴 빨간 테두리가, 무승부 상자에는 검은 테두리가 적용됩니다.
